          ...
          <div style={{ display: "flex", justifyContent: "flex-end", alignItems: "center", gap: SP.xs, marginBottom: SP.md }}>
            {LANGS.map((l) => (
              <button key={l.code} onClick={() => setLang(l.code)}
                style={{ ...TYPE.small, fontWeight: 600, padding: "8px 12px", minHeight: 44, borderRadius: 999, cursor: "pointer",
            ...
            <button onClick={() => setMode(mode === "dark" ? "light" : "dark")}
              title="Toggle theme"
              style={{ ...TYPE.small, marginLeft: SP.sm, padding: "8px 14px", minHeight: 44, borderRadius: 999, cursor: "pointer",
